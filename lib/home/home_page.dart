...
class HomePage extends StatefulWidget {
  ...
  static Future<List<CategoryItem>> fetchData() async {
    final response =
        await http.get(Uri.parse('http://localhost:3001/categories'));
...
Future<List<MealItem>> fetchDataMeals() async {
  final response = await http.get(Uri.parse('http://localhost:3001/meals'));
  if (response.statusCode == 200) {
    List<dynamic> json = jsonDecode(response.body);
      ...
      children: [
        ...
        CustomContainer(
          ...
          child: ClipRRect(
            ...
            child: Image.network(
              'https://d1csarkz8obe9u.cloudfront.net/posterpreviews/chef-logo%2Ccooking-logo%2Crestaurant-logo-design-template-8048c6b88c3702da6e0804bc38ce7f33_screen.jpg?ts=1672750337',
              fit: BoxFit.cover,
            ),
          ),
        )
